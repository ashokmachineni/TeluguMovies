...
final class TrackSelectionHelper implements View.OnClickListener,
    ...
    private MappingTrackSelector.TrackInfo trackInfo;
     ...
     */
    public void showSelectionDialog(Activity activity, CharSequence title, MappingTrackSelector.TrackInfo trackInfo,
                                    int rendererIndex) {
